...
<body>
	...
	<div class="container-fluid">
		<a href="cars" class="navbar-brand " data-toggle="tooltip"
			data-placement="top" title="Home"> <img src="/images/cars.jpg"
			height="60%" style="margin-left:480px"></a></div>
			<h1 style="font-weight: 600 bold; margin-left:565px"><b>ABC Car portal</b></h1>
			<h2 style ="color:Red; margin-left:565px">Buy & Sell used car</h2>
	...
	<div class="container">
		<sec:authorize access="hasRole('Users')">
			<!-- post car link-->
			<div class="row p-3 mb-5" style="background-color: #696969;">
				<div class="col-5">
					...
					<c:if test="${c.sellStatus != 'sold'}">
						<div class="card" style="width: 400px">
							...
							<div class="card-body">
								...
								<p class="card-text">
									<i class="fas fa-tags"></i>&nbsp;RS ${c.price}
								</p>
